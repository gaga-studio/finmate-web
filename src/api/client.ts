...
export type MateExploreSearchPage = paths['/mate/explore/search']['post']['responses'][200]['content']['application/json']
export type MateExploreSearchCard = MateExploreSearchPage['items'][number]
