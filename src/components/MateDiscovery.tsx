...
export function MateDiscovery({ groups }: { groups: MateGroup[] }) {
  ...
  return <div className="mate-tab-stack mate-view-enter">
    {primary ? <section className="mate-group-section">
      ...
      <Link
        aria-label="나와 비슷한 그룹 탐색"
        className="mate-card mate-group-card mate-group-primary-link"
        to={`/mates/group/${primary.groupId}`}
      >
